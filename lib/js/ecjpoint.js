...
ECJPoint.prototype.add = function (p) {
  ...
  var s1 = this.y.redMul(pz2).redIMul(p.z)
  ...
  var ny = r.redIMul(v.redISub(nx)).redISub(s1.redIMul(h3))
  var nz = this.z.redMul(p.z).redIMul(h)
...
ECJPoint.prototype.mixedAdd = function (p) {
  ...
  var nx = r.redSqr().redIAdd(h3).redISub(v).redISub(v)
  var ny = r.redIMul(v.redISub(nx)).redISub(s1.redMul(h3))
