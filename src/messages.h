...
#define EC_PRIVATE_KEY_TYPE_INVALID "secret key should be a Buffer"
#define EC_PRIVATE_KEY_LENGTH_INVALID "secret key length is invalid"
#define EC_PRIVATE_KEY_TWEAK_ADD_FAIL "tweak out of range or resulting secret key is invalid"
...
#define EC_PUBLIC_KEY_CREATE_FAIL "secret was invalid, try again"
