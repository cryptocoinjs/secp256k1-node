  ...
  describe('recover', function () {
    ...
    it('signature is invalid (r equal N)', function () {
      expect(function () {
        ...
        secp256k1.recover(util.getMessage(), signature, 0)
