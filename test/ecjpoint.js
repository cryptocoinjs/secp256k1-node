...
test('ECJPoint', function (t) {
  ...
  t.test('neg', function (t) {
    ...
    util.repeat(t, 'random tests', util.env.repeat, function (t) {
      ...
      t.equal(result.x.ucmp(ecjpoint.x), 0)
      t.equal(result.y.ucmp(ecjpoint.y.redNeg()), 0)
      t.equal(result.z.ucmp(ecjpoint.z), 0)
      t.end()
    })
  ...
  t.test('add', function (t) {
    t.test('O + P -> P', function (t) {
      ...
      t.equal(result.x.ucmp(ecjpoint2.x), 0)
      t.equal(result.y.ucmp(ecjpoint2.y), 0)
      t.equal(result.z.ucmp(ecjpoint2.z), 0)
      t.end()
    })
    ...
    t.test('P + O -> P', function (t) {
      ...
      var result = ecjpoint1.add(ecjpoint2)
      t.equal(result.x.ucmp(ecjpoint1.x), 0)
      t.equal(result.y.ucmp(ecjpoint1.y), 0)
      t.equal(result.z.ucmp(ecjpoint1.z), 0)
      t.end()
    })
    ...
    t.test('P + P -> 2P', function (t) {
      ...
      t.equal(result.z.ucmp(expected.z), 0)
      t.end()
    })
  ...
  t.test('mixedAdd', function (t) {
    t.test('O + P -> P', function (t) {
      ...
      t.equal(result.y.ucmp(ecpoint.y), 0)
      t.end()
    })
    ...
    t.test('P + O -> P', function (t) {
      ...
      t.equal(result.x.ucmp(ecjpoint.x), 0)
      t.equal(result.y.ucmp(ecjpoint.y), 0)
      t.equal(result.z.ucmp(ecjpoint.z), 0)
      t.end()
    })
