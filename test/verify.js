...
module.exports = function (secp256k1, opts) {
  describe('verify', function () {
    it('message should be a Buffer', function () {
      expect(function () {
        secp256k1.verify(null, util.getSignature(), util.getPublicKey())
      }).to.throw(TypeError, /message/)
    })

    it('signature should be a Buffer', function () {
      expect(function () {
        secp256k1.verify(util.getMessage(), null, util.getPublicKey())
      }).to.throw(TypeError, /signature/)
    })

    it('public key should be a Buffer', function () {
      expect(function () {
        secp256k1.verify(util.getMessage(), util.getSignature(), null)
      }).to.throw(TypeError, /public/)
    })

    it('message length is invalid', function () {
      expect(function () {
        secp256k1.verify(util.getMessage().slice(1), util.getSignature(), util.getPublicKey())
      }).to.throw(RangeError, /message/)
    })

    it('signature length is invalid', function () {
      expect(function () {
        secp256k1.verify(util.getMessage(), util.getSignature().slice(1), util.getPublicKey())
      }).to.throw(RangeError, /signature/)
    })

    it('public key length is invalid', function () {
      expect(function () {
        secp256k1.verify(util.getMessage(), util.getSignature(), util.getPublicKey().slice(1))
    ...
    it('signature is invalid (r equal N)', function () {
      expect(function () {
        ...
        secp256k1.verify(util.getMessage(), signature, util.getPublicKey())
    ...
    it('public key is invalid (version is 0x01)', function () {
      expect(function () {
        ...
        pubKey[0] = 0x01
        secp256k1.verify(util.getMessage(), util.getSignature(), pubKey)
